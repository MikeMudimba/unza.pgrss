              ...
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="update" method="POST" action="{{ url('/student/research-proposal/update') }}" enctype="multipart/form-data" >
                      {{ csrf_field()}}
            ...
            <div class="modal fade" id="exLargeModalRetract" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  <form id="retract" method="POST" action="{{ url('/student/research-proposal/delete') }}" enctype="multipart/form-data" >
                    {{ csrf_field()}}
                    <input type="hidden" value="{{ $project->id }}" name="project_id"/>
