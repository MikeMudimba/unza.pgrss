                ...
                <div class="table-responsive">
                  <table class="table table-striped">
                    <tbody class="table-border-bottom-0" style="border:1px solid #eee;word-wrap: break-word;word-break:break-word;">
                      ...
                      <tr>
                        <th>Supervisor contacts</th>
                        <td>{{ 'Email '.$supervisor->email.' : Phone '.$supervisor->phone }}</td>
                      </tr>
              ...
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel4">Update seminer week submissions</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                  </div>
                  <div class="modal-body">
                    <form id="update" method="POST" action="{{ url('/student/seminer-week/update') }}" enctype="multipart/form-data" >
                      {{ csrf_field()}}
                      <input type="hidden" value="{{ $project->id }}" name="project_id"/>
                        ...
                        <div class="mb-3 col-md-12">
                          ...
                          <div class="input-group">
                            <label class="input-group-text" for="inputGroupFile03">PDF</label>
                        ...
                        <div class="mb-3 col-md-12">
                          ...
                          <div class="input-group">
                            <label class="input-group-text" for="inputGroupFile03">PPTX</label>
            ...
            <div class="modal fade" id="exLargeModalRetract" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  <form id="retract" method="POST" action="{{ url('/student/seminer-week/delete') }}" enctype="multipart/form-data" >
                    {{ csrf_field()}}
                    <input type="hidden" value="{{ $project->id }}" name="project_id"/>
