...
<h4 class="fw-bold py-3 mb-4">
  <span class="text-muted fw-light">Student /</span> Dissertation
</h4>
        ...
        <div class="row">
          <div class="col-md-12">
            <div class="card mb-4" id="print-me">
              <h5 class="card-header">Dissertation Details</h5>
              <hr class="my-0">
              <div class="card-body">
              ...
              <div class="modal-dialog modal-xl" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                    <form id="update" method="POST" action="{{ url('/student/dissertation/update') }}" enctype="multipart/form-data" >
                      {{ csrf_field()}}
            ...
            <div class="modal fade" id="exLargeModalRetract" tabindex="-1" aria-hidden="true">
              <div class="modal-dialog" role="document">
                <div class="modal-content">
                  ...
                  <div class="modal-body">
                  <form id="retract" method="POST" action="{{ url('/student/dissertation/delete') }}" enctype="multipart/form-data" >
                    {{ csrf_field()}}
                    <input type="hidden" value="{{ $project->id }}" name="project_id"/>
